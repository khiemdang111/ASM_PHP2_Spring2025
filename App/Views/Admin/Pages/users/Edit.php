          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group text-center">
                <img src="/public/assets/images/<?= $data['avatar'] ?>" class="rounded rounded-circle img-fluid mx-auto d-block" width="250px"
                  style="max-height: 250px" alt=""> <br>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="<?= $data['username'] ?>"
                  placeholder="Username người dùng" class="form-control">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input type="text" id="password" name="password" value="<?= isset($data['password']) ? '****************' : '' ?>" placeholder="Mật khẩu"
                  class="form-control">
              </div>
            </div>
            <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="status" name="status" aria-label="Default select example">
                  ...
                  <?php elseif ($data['status'] == 2): ?>
                    <option value="2" selected>Bị khóa</option>
