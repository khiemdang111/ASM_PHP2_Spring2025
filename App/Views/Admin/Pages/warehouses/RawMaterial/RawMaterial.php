...
class RawMaterial extends BaseView
{
  public static function render($data = null)
  {
    ...
    <div class="row wrapper border-bottom white-bg page-heading" style="display: flex; align-items: center;">
      <div class="col-lg-9">
        <h2>Quản lí nguyên liệu</h2>
        <ol class="breadcrumb">
          <li>
            <a href="index.html">Trang chủ</a>
          </li>
          <li class="active">
            <a>Quản lí nguyên liệu</a>
          </li>
        </ol>
      </div>
      <div class="col-lg-2 align-end px-3" style="text-align: end">
        <a href="/admin/warehouse/rawmaterial/create" class="btn btn-primary">Thêm mới</a>
      </div>
    </div>
