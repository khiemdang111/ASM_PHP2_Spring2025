                        ...
                        <tr>
                          ...
                          <label class="switch">
                              <input type="checkbox" <?= $item['status'] == 1 ? 'checked' : '' ?> class="status"
                                data-field="status" data-model="posts" data-modelId="<?= $item['id'] ?>"
                                value="<?= $item['status'] ?>">
                            ...
                            <div class="custom-icon-detail">
                              ...
                              <label class="popup">
                                ...
                                <nav class="popup-window">
                                  <ul>
                                    <li>
                                      <form action="/admin/post/restore/<?= $item['id'] ?>" method="post"
                                        style="display: inline-block;">
                                        <input type="hidden" name="method" value="POST">
                                        <input type="hidden" name="table" value="posts">
                                        <input type="hidden" name="urlTable" value="post">
                                        <button type="submit">
                                    ...
                                    <hr>
                                    <li>
                                      <form action="/admin/post/deletePermanently/<?= $item['id'] ?>" method="post"
                                        style="display: inline-block;">
                                        <input type="hidden" name="method" value="POST">
                                        <input type="hidden" name="table" value="posts">
                                        <input type="hidden" name="urlTable" value="post">
