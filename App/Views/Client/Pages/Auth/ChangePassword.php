    ...
    <div class="container">
      <div class="w-50 mx-auto my-5">
        <div class="card">
          ...
          <div class="card-body">
            <form action="/updata/password/<?= $data['id'] ?>" method="post">
              <input type="hidden" name="method" value="POST">
              <div class="mb-3">
                <label for="oldpassword" class="form-label text-dark">Nhập mật khẩu cũ</label>
              ...
              <div class="mb-3">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="password" class="form-control" id="password" name="newpassword" oninput="validatePassword(this.value)">
              ...
              <div class="mb-3">
                <div class="form-group">
                  <label for="password2" class="form-label text-dark">Nhập lại mật khẩu mới:</label>
                  <div class="input-group">
                    <input type="password" class="form-control" id="password2" name="checkpassword" oninput="checkValidatePassword(this.value)">
                    <div class="input-group-append">
                ...
                <div class="form-group">
                  <span id="passwordLength"><i class="fas fa-times
                                     text-danger"></i> Nhập lại mật khẩu mới</span>
                </div>
                <span id="errorMessageLength" class="font-weight-bold
                         text-danger"></span>
              </div>
          </div>
