                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <label for="ward" class="form-label">Xã/Phường: <span
                                                                        class="text-danger">*</span></label>
                                                                <select name="ward" id="ward" class="form-select setupSelect2">
                                                                    <option value="">------Chọn-----</option>
                                                                </select>
                                ...
                                <form action="#">
                                        ...
                                        <tbody>
                                            ...
                                            if ($data != null):
                                                foreach ($data['name'] as $index => $productName) {
                                                    ...
                                                    <tr>
                                                        <th><?= $productName ?></th>
                                                        <td class=""><span class="price"><?= $price ?></span> x <span
                                                                class="quantity"><?= $quantity ?></span> </td>
                                                    </tr>
                                                    <?php
                                                }
                                            endif;
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" checked type="radio" name="pay"
                                                id="pay-live">
